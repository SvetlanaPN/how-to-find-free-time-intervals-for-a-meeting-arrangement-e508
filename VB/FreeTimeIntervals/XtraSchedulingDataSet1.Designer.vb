...
Namespace FreeTimeIntervals.XtraSchedulingDataSet1TableAdapters
	...
	Partial Public Class ResourcesTableAdapter
		...
		Public Overridable Function Delete(ByVal Original_UniqueID As Integer, ByVal Original_ResourceID As Integer, ByVal Original_ResourceName As String, ByVal Original_Color As Global.System.Nullable(Of Integer)) As Integer
		...
		Public Overridable Function Insert(ByVal ResourceID As Integer, ByVal ResourceName As String, ByVal Color As Global.System.Nullable(Of Integer), ByVal Image() As Byte, ByVal CustomField1 As String) As Integer
		...
		Public Overridable Function Update(ByVal ResourceID As Integer, ByVal ResourceName As String, ByVal Color As Global.System.Nullable(Of Integer), ByVal Image() As Byte, ByVal CustomField1 As String, ByVal Original_UniqueID As Integer, ByVal Original_ResourceID As Integer, ByVal Original_ResourceName As String, ByVal Original_Color As Global.System.Nullable(Of Integer), ByVal UniqueID As Integer) As Integer
