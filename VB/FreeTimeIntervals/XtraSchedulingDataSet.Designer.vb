...
Namespace FreeTimeIntervals
	...
	Partial Public Class XtraSchedulingDataSet
		...
		Partial Public Class AppointmentsDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddAppointmentsRow(ByVal Type As Integer, ByVal StartDate As System.DateTime, ByVal EndDate As System.DateTime, ByVal AllDay As Boolean, ByVal Subject As String, ByVal Location As String, ByVal Description As String, ByVal Status As Integer, ByVal Label As Integer, ByVal ResourceID As Integer, ByVal ReminderInfo As String, ByVal RecurrenceInfo As String, ByVal CustomField1 As String) As AppointmentsRow
...
Namespace FreeTimeIntervals.XtraSchedulingDataSetTableAdapters
	...
	Partial Public Class AppointmentsTableAdapter
		...
		Public Overridable Function Insert(ByVal Type As Global.System.Nullable(Of Integer), ByVal StartDate As Global.System.Nullable(Of Global.System.DateTime), ByVal EndDate As Global.System.Nullable(Of Global.System.DateTime), ByVal AllDay As Global.System.Nullable(Of Boolean), ByVal Subject As String, ByVal Location As String, ByVal Description As String, ByVal Status As Global.System.Nullable(Of Integer), ByVal Label As Global.System.Nullable(Of Integer), ByVal ResourceID As Global.System.Nullable(Of Integer), ByVal ReminderInfo As String, ByVal RecurrenceInfo As String, ByVal CustomField1 As String) As Integer
		...
		Public Overridable Function Update(ByVal Type As Global.System.Nullable(Of Integer), ByVal StartDate As Global.System.Nullable(Of Global.System.DateTime), ByVal EndDate As Global.System.Nullable(Of Global.System.DateTime), ByVal AllDay As Global.System.Nullable(Of Boolean), ByVal Subject As String, ByVal Location As String, ByVal Description As String, ByVal Status As Global.System.Nullable(Of Integer), ByVal Label As Global.System.Nullable(Of Integer), ByVal ResourceID As Global.System.Nullable(Of Integer), ByVal ReminderInfo As String, ByVal RecurrenceInfo As String, ByVal CustomField1 As String, ByVal Original_UniqueID As Integer, ByVal Original_Type As Global.System.Nullable(Of Integer), ByVal Original_StartDate As Global.System.Nullable(Of Global.System.DateTime), ByVal Original_EndDate As Global.System.Nullable(Of Global.System.DateTime), ByVal Original_AllDay As Global.System.Nullable(Of Boolean), ByVal Original_Subject As String, ByVal Original_Location As String, ByVal Original_Status As Global.System.Nullable(Of Integer), ByVal Original_Label As Global.System.Nullable(Of Integer), ByVal Original_ResourceID As Global.System.Nullable(Of Integer), ByVal UniqueID As Integer) As Integer
			If (Type.HasValue = True) Then
			...
			End If
			Me.Adapter.UpdateCommand.Parameters(13).Value = (CInt(Fix(Original_UniqueID)))
			If (Original_Type.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(14).Value = (CObj(0))
				Me.Adapter.UpdateCommand.Parameters(15).Value = (CInt(Fix(Original_Type.Value)))
			Else
			...
			If (Original_Status.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(27).Value = (CInt(Fix(Original_Status.Value)))
			Else
			...
			If (Original_Label.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(29).Value = (CInt(Fix(Original_Label.Value)))
			Else
			...
			If (Original_ResourceID.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(31).Value = (CInt(Fix(Original_ResourceID.Value)))
			Else
